...
<head>
    ...
    <link rel="icon" href="{{ asset('img/microsoft.ico') }}" />
</head>
...
<body>
    <header>
        <nav>
            ...
            <div id="nav-2">
                ...
                <div id="nav-2-menu">
                    <input type="checkbox" id="small-ham-1" class="chevron-switch" hidden />
                    ...
                    <input type="checkbox" id="small-ham-2" class="chevron-switch" hidden />
                    ...
                    <input type="checkbox" id="small-ham-3" class="chevron-switch" hidden />
                    ...
                    <input type="checkbox" id="small-ham-4" class="chevron-switch" hidden />
                    ...
                    <input type="checkbox" id="small-ham-5" class="chevron-switch" hidden />
                    ...
                    <input type="checkbox" id="small-ham-6" class="chevron-switch" hidden />
    ...
    <main>
        ...
        <section id="aem">
            <ul>
                <li>
                    <img src="./img/gldn-Quick-Link-Icon-80x80-Microsoft-365.webp" alt="" />
        ...
        <section class="four-box">
            ...
            <div class="col-8">
                <a href="#" class="cta">
                    <img src="./img/gldn-XGP-Game-Pass-Ultimate-Characters-06102010-1.avif" alt="#" />
                    <div class="card-box">
        ...
        <section id="layout">
            <div class="highlight">
                <picture>
                    <source media="(min-width: 1400px)" srcset="./img/swiper/gldn-MSFT-hero-Edge_VP5-1596x600.avif" />
                    <source media="(min-width: 1084px)" srcset="./img/swiper/gldn-MSFT-hero-Edge_VP3-1083x600.avif" />
                    <source media="(min-width: 860px)" srcset="./img/swiper/gldn-MSFT-hero-Edge_VP2-859x540.avif" />
                    <source media="(min-width: 540px)" srcset="./img/swiper/gldn-MSFT-hero-Edge_VP2-859x540.avif" />
                    <img src="./img/swiper/gldn-MSFT-hero-Edge_VP5-1596x600.avif" alt="" width="100%" />
                </picture>
                <div class="card-introduce left">
                    ...
                    <div class="link-group">
                        <div class="link-group">
                            <a href="https://www.microsoft.com/zh-tw/edge?form=MI13F3&OCID=MI13F3" download=""
                                class="btn-blue size-3">立即下載</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="four-box">
            <div class="col-8">
                <a href="#" class="cta">
                    <img src="./img/gldn-Surf-CP-SurfaceFamilyForBusiness.avif" alt="#" />
                    <div class="card-box">
            ...
            <div class="col-8">
                <a href="#" class="cta">
                    <img src="./img/Content-Card-Microsoft-365-For-Business-Woman-Teams-Call.webp" alt="#" />
                    <div class="card-box">
        ...
        <div id="foot-nav-6">
            ...
            <div class="foot-nav">
                ...
                <ul>
                    <li><a href="#">開發人員中心</a></li>
                    <li><a href="#">文件</a></li>
                    <li><a href="#">Microsoft Learn<< /a>
                    </li>
                    <li><a href="#">Microsoft 技術社群<< /a>
                    </li>
                    <li><a href="#">Azure Marketplace<< /a>
                    </li>
                    <li><a href="#">Microsoft Power Platform<< /a>
                    </li>
                    <li><a href="#">Microsoft Power Platform<< /a>
                    </li>
                    <li><a href="#">Visual Studio<< /a>
                    </li>
                </ul>
            </div>
            <div class="foot-nav">
